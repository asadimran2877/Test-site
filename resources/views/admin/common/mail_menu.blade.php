        ...
        <div class="box-body no-padding" style="display: block;">
            <ul class="nav nav-pills nav-stacked">
                ...
                <li {{ isset($list_menu) && $list_menu == 'menu-37' ? 'class=active' : '' }}>
                    <a href="{{ URL::to(\Config::get('adminPrefix') . '/template/37') }}">{{ __('User Registration') }}</a>
                </li>

                <li {{ isset($list_menu) && $list_menu == 'menu-38' ? 'class=active' : '' }}>
                    <a href="{{ URL::to(\Config::get('adminPrefix') . '/template/38') }}">{{ __('User Update') }}</a>
                </li>

                <li {{ isset($list_menu) && $list_menu == 'menu-39' ? 'class=active' : '' }}>
                    <a href="{{ URL::to(\Config::get('adminPrefix') . '/template/39') }}">{{ __('Agent Registration') }}</a>
                </li>

                <li {{ isset($list_menu) && $list_menu == 'menu-40' ? 'class=active' : '' }}>
                    <a href="{{ URL::to(\Config::get('adminPrefix') . '/template/40') }}">{{ __('Agent Update') }}</a>
                </li>
                
                <li {{ isset($list_menu) && $list_menu == 'menu-41' ? 'class=active' : '' }}>
                    <a href="{{ URL::to(\Config::get('adminPrefix') . '/template/41') }}">{{ __('User Deposit') }}</a>
                </li>
                
                <li {{ isset($list_menu) && $list_menu == 'menu-42' ? 'class=active' : '' }}>
                    <a href="{{ URL::to(\Config::get('adminPrefix') . '/template/42') }}">{{ __('User Withdrawal') }}</a>
                </li>

                <li {{ isset($list_menu) && $list_menu == 'menu-43' ? 'class=active' : '' }}>
                    <a href="{{ URL::to(\Config::get('adminPrefix') . '/template/43') }}">{{ __('Withdraw verification') }}</a>
                </li>
