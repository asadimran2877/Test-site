                                    ...
                                    <div class="panel panel-default">
                                        ...
                                        <div id="collapse{{ $method->id }}" class="panel-collapse collapse">
                                            <div class="panel-body">
                                                ...
                                                @if (isActive('Agent'))
                                                    @if ($method->name == 'Cash')
                                                        <!-- Agent Charge Percentage -->
                                                        <div class="form-group">
                                                            <label class="col-sm-3 control-label" for="agent_percentage">{{ __('Agent Percentage') }}</label>
                                                            <div class="col-sm-5">
                                                                <input class="form-control agent_percentage" name="agent_percentage[]" type="text" value="{{ isset($method->fees_limit->agent_percentage)? number_format((float) $method->fees_limit->agent_percentage, $preference, '.', ''): number_format((float) 0.0, $preference, '.', '') }}" id="agent_percentage_{{ $method->id }}" {{ isset($method->fees_limit->has_transaction) && $method->fees_limit->has_transaction == 'Yes'? '': 'readonly' }} onkeypress="return isNumberOrDecimalPointKey(this, event);" oninput="restrictNumberToPrefdecimalOnInput(this)">
                                                                <small class="form-text text-muted"><strong>{{ allowedDecimalPlaceMessage($preference) }}</strong></small>
                                                                <span id="total_percentage_error3"></span>
                                                                @if ($errors->has('agent_percentage'))
                                                                    <span class="help-block">
                                                                        <strong>{{ $errors->first('agent_percentage') }}</strong>
                                                                    </span>
                                                                @endif
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <p>{{ __('If not set, charge percentage is ') }} {{ number_format((float) 0.0, $preference, '.', '') }} </p>
                                                            </div>
                                                        </div>
                                                        <div class="clearfix"></div>
                                                    @endif
    ...
    <script type="text/javascript">
        ...
        $(".has_transaction").click(function() {
            ...
            if ($('#has_transaction_' + payment_method_id).prop('checked') == true) {
                ...
                $('#agent_percentage_' + payment_method_id).prop("readonly", false);
                ...
                $('#agent_percentage_' + payment_method_id).prop("readonly", true);
                    ...
                    if (data.status == 200) {
                        ...
                        $.each(feesLimt, function(key, value) {
                            ...
                            if (value.fees_limit != null) {
                                ...
                                $('#agent_percentage_' + value.id).val(formatNumberToPrefDecimal(value.fees_limit.agent_percentage));
                                ...
                                if (value.fees_limit.has_transaction == 'Yes') {
                                    ...
                                    $('#agent_percentage_' + value.id).prop("readonly", false);
                                    ...
                                    $('#agent_percentage_' + value.id).prop("readonly", true);
                                ...
                                $('#agent_percentage_' + value.id).val(formatNumberToPrefDecimal('0.00000000'));
                ...
                success: function(data) {
                    if (data.status == 200) {
                        ...
                        if (checkDefaultCurrency == 1) {
                            ...
                            $("#agent_percentage").prop("readonly", false);
                            ...
                            $("#agent_percentage").prop("readonly", true);
                        ...
                        $.each(feesLimt, function(key, value) {
                            ...
                            if (value.fees_limit != null) {
                                ...
                                $('#charge_percentage_' + value.id).val(formatNumberToPrefDecimal(value.fees_limit.charge_percentage));
                                $('#agent_percentage' + value.id).val(formatNumberToPrefDecimal(value.fees_limit.agent_percentage));
                                $('#charge_fixed_' + value.id).val(formatNumberToPrefDecimal(value.fees_limit.charge_fixed));
