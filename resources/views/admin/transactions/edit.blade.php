                                    ...
                                    <div class="mt-4 p-4 bg-secondary rounded shadow">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" class="form-control" name="receiver" value="
                                                @switch($transaction->transaction_type_id)
                                                    ...
                                                    @case(Exchange_From)
                                                    @case(Exchange_To)
                                                    @case(module('Remittance') ? Remittance : false)
                                                    @case(Withdrawal)
                                        ...
                                        @if ($transaction->status)
                                                ...
                                                <div class="col-sm-9">
                                                    ...
                                                    @elseif (module('Agent') && $transaction->payment_method->name == "Cash")
                                                        <p class="form-control-static"><span class="label label-danger" id="referrral-award-status" style="white-space: unset !important;">Status Cannot Be Changed</span></p>
                                                    @else
                                                        <select class="form-control select2" name="status" style="width: 60%;">
                                                            ...
                                                            @elseif (module('Remittance') && $transaction->transaction_type_id == Remittance)
                                                                <option value="Success" {{ $transaction->status ==  'Success'? 'selected':"" }}>Success</option>
                                                                <option value="Pending"  {{ $transaction->status == 'Pending' ? 'selected':"" }}>Pending</option>
                                                                <option value="Blocked"  {{ $transaction->status == 'Blocked' ? 'selected':"" }}>Cancel</option>
                                                            @endif
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="row">
                                                    ...
                                                    @if (!isset($transaction->refund_reference) && !(config('referral.is_active') && $transaction->transaction_type_id == Referral_Award) && (!module('Agent') || $transaction->payment_method->name != "Cash"))
                                                        <div class="col-md-1">
