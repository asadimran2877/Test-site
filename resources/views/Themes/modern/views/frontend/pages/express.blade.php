...
<section class="section-06 sector-guides mt50">
    ...
    <div class="guidepara-style mt30">
        <div class="guideBox-color">
            {{-- <h3><strong>Note: <b style="text-decoration: underline;color: #c64e25;">setReturnUrl funcation has been changed to setSuccessUrl. So, if you are using Noropay lower than v1.9, update your application's database with the update sql query, mentioned in 'section-sdk-update-query', from Noropay v1.9 upgrade documentation.<br></b></strong>
            </h3>
            <br> --}}
            <h4>
                {{ __('Now, go to') }}
                <strong>
                    php-sdk/src/Noropay/Rest/Connection.php,
                </strong>
                {{ __('then change') }}
                <strong>
                    BASE_URL
...
<pre style="display:block;">
    ...
    <span style="color:#707070;">//if you want to change the namespace/path from 'Noropay' - lines[1-5] - to your desired name,
    i.e. (use Noropay\Api\Amount; to use MyDomain\Api\Amount;), then you must change the folders name that holds
    the API classes as well as change the property 'Noropay' in (autoload->psr-0) of (php-sdk/composer.json) file to your
    desired name and run "composer dump-autoload" command from sdk root</span>

    <span style="color:#cf1ffb;">use</span> Noropay\Api\Payer;
    <span style="color:#cf1ffb;">use</span> Noropay\Api\Amount;
    <span style="color:#cf1ffb;">use </span>Noropay\Api\Transaction;
    <span style="color:#cf1ffb;">use</span> Noropay\Api\RedirectUrls;
    <span style="color:#cf1ffb;">use</span> Noropay\Api\Payment;

    <span style="color:#707070;">//Payer Object</span>
    <span style="color:#fd8f00;">$payer</span> = <span style="color:#cf1ffb;">new</span> Payer();
    <span style="color:#fd8f00;">$payer</span>->setPaymentMethod(<span style="color:#55bb17;">'Noropay'</span>); <span style="color:#707070;">//preferably, your system name, example - Noropay</span>
    ...
    example - http://norobshopper.com/Noropay_sdk/example-success.php</span>
    ...
    cancellation of payment, example -  http://norobshopper.com/Noropay_sdk/</span>
