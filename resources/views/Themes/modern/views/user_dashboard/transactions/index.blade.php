                            ...
                            <div class="d-flex flex-wrap">
                                ...
                                <div class="pr-3 mt-2">
                                    <select class="form-control w-200p" id="type" name="type">
                                        ...
                                        <option value="{{Remittance}}" <?= ($type == Remittance) ? 'selected' : '' ?>>
                                            <!-- TODO: translation -->
                                            {{ __('Remittance') }}
                                        </option>
                                        @endif
                                                            ...
                                                            @else
                                                                ...
                                                                <td class="text-left">
                                                                    <p class="text-16 mb-0">
                                                                        ...
                                                                        @elseif(module('Remittance') && $transaction->transaction_type->name == 'Remittance')
                                                                            @if(!empty($payment_method))
                                                                            {{ __('MoneyTransfer via') }} {{ $payment_method }}
                                                                            @endif
