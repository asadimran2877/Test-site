...
return [
    ...
    'home'                 => [
        ...
        'banner'          => [
            'title'      => 'Send & Receive Money Super Fast, :br and Secure to Your loved ones',
        ...
        'choose-us'       => [
            'title'      => 'Why choose us?',
            'sub-title1' => 'We are not bank. To transfer money, withdrawal & exchange currency, we are committed to finding you the best real-time exchange rates with significantly low fees.',
            'sub-title2' => 'Get your money to family & friends instant, you just need a working email address or a phone number.',
            'sub-title3' => 'We have a wide choice of ways to send & recieve money to any location. ',
        ],
        'payment-gateway' => [
        ...
        'services'        => [
            't1' => 'Payment API',
            's1' => 'Manage customers experience by integrating ' . $getCompanyName . ' seamless API interface within your website.',
            't2' => 'Online Payments',
            's2' => 'Whatever your choice, we work with you multiple ways - credit, debit, bank account transfer, cash or eCurrency pickup, we ensure peace of mind.',
            't3' => 'Currency Exchange',
            's3' => 'You can easily exchange Default currency to any other currency easy and fast.',
            't4' => 'Payment Request',
            's4' => 'With our systems, you can make transfer request from any country to receive money in any local currency of choice.',
            't6' => 'Fraud Detection',
            's6' => 'Our multiple protection assures and safeguards your peace of mind. we help to keep your account more secured & reliable. Enjoy safe seamless online payments.',
        ],
        'how-work'        => [
            'title'      => 'How it works',
    ...
    'send-money'           => [
        'banner'    => [
            ...
            'sub-title' => 'Send and Receive Money Quickly and easily.',
            'sign-up'   => 'Sign Up to ' . $getCompanyName,
            'login'     => 'Log In Now',
        ],
        'section-a' => [
            'title'         => 'Send Money Globally within Minutes for Multiple Currency.',
            'sub-section-1' => [
                'title'     => 'Register Account',
                'sub-title' => 'First step is to be a registered user, then login into your account and appropriately enter your card or bank details using our multiple secured thirdparty gateways.',
            ],
            'sub-section-2' => [
                'title'     => 'Select Your Recipient',
                'sub-title' => 'Enter your recipient email address, then
                            add the currency amount to send securely. These details are securely protected, won\'t be share with others for safety',
            ],
            'sub-section-3' => [
                'title'     => 'Send Money',
                'sub-title' => 'After money is transferred into designated account, the recipient will be notified via the email address provided by the sender.',
            ],
        ],
        'section-b' => [
            'title'     => 'Send Money Within Seconds',
            'sub-title' => 'Download our app for free to send money online in minutes to over 130 other countries. Track your payments and view transfer history from anywhere. </br> </br> There are multiple ways we pay!',
        ],
        'section-c' => [
            'title'     => 'Send Money to Anyone, Anywhere and Instantly with ' . $getCompanyName . ' System',
            'sub-title' => 'Transfer funds to your friends & family globally in a variety of ways using the ' . $getCompanyName . ' web portal, mobile app, Merchant POS, mobile money, cash pickup, bank account or others payment gateway. Funds directly go into reciepient account whether they have any bank account or not. You can send/request for money via different type of Payment Gateway in different currencies.',
        ],
        'section-d' => [
        ...
        'section-e' => [
            ...
            'sub-title' => 'Now, you have no trouble for having cash money. Anyone can send money from their card, bank
                            account, paypal balance or other payment gateway. You will notify via an active email.',
        ],
    ],
    ...
    'request-money'        => [
        'banner'    => [
            ...
            'sub-title'      => 'Adopt industry-leading technology for maximum protection.',
            'sign-up'        => 'Request Money',
        ...
        'section-a' => [
            ...
            'sub-title'     => 'Requesting money is an efficient and polite way of asking for money you\'re owed. </br> Use
                            ' . $getCompanyName . ' system to send, receive or transfer money from colleagues, friends or love ones.',

            'sub-section-1' => [
                'title'     => 'Register Account',
                'sub-title' => 'First thing first - be a register user, then login into your user account and enter the bank or card information required to implement your request.',
            ],
            'sub-section-2' => [
                'title'     => 'Select Your Recipient',
                'sub-title' => 'Enter your recipient\'s active email address that won\'t be share with others for safety, then
                            add amount and currency to securely send.',
            ],
            'sub-section-3' => [
                'title'     => 'Request Money',
                'sub-title' => 'After requesting money the recipient will be notified via an email when the transferred money hits their account.',
            ],
        ],
        'section-b' => [
            'title'     => 'Send Money using your Mobile Phone',
            'sub-title' => 'Now, you have no excuse not to have cash or conveniently make quick remittances. We strive to help our customers get the most out of life. Anyone can send money from their card, bank account, paypal balance, through our Merchant or any of our other multiple payment processing options. Whichever you choose, you will be notified via an email.',
        ],
        'section-c' => [
            'title'     => 'Request money with ' . $getCompanyName . ' Mobile App',
            'sub-title' => 'Anyone with active email address can request a remittance, with or without a bank account and be paid through PayPal, Mollie, strip, 2checkout, eCurrencies or direct cash pickup from ' . $getCompanyName . ' Merchant payment corridors.',
        ],
        'section-d' => [
            'title'     => 'Request Money To be sent to Anyone, Anywhere, Instantly Using ' . $getCompanyName . ' System',
            'sub-title' => 'Transfer funds to your friends and family globally through the ' . $getCompanyName . ' mobile app, bank account or others payment gateway. Funds directly go into your account whether the recipient have any account or not. You can send/request for money via different type of Payment Gateway with different currencies.',
        ],
        'section-e' => [
            'title'   => 'Faster, Simpler, Safer – Send Money To Those You Love Today.',
            'sign-up' => 'Sign Up to ' . $getCompanyName,
