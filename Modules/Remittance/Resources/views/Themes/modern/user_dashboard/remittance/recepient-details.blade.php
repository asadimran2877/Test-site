        ...
        <div class="container-fluid">
            ...
            <div class="row mt-4">
                <div class="col-lg-4">
                    <!-- Sub title start -->
                    <div class="mt-5">
                        <h3 class="sub-title">{{ __('Recepient Details') }}</h3>
                        <p class="text-gray-500 text-16"> {{ __('Please Input Your Recipient Information Details. It helps Admin to send Money.') }}</p>
                        <br>
                        <p class="text-gray-500 text-16"> {{ __('Please Input Your Bank Details. Admin Send Money to this Bank account') }}</p>
                    </div>
                    <!-- Sub title end-->
                </div>
                            ...
                            <div class="bg-secondary mt-5 shadow p-35">
                                <div>
                                    <form action="{{ route('delivered.details') }}" method="post" id="remittanceDetails">
                                        ...
                                        <div id="bankForm">
                                            <div class="mb-4">
                                                <p class="sub-title">{{ __('Bank Details') }}</p>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 text-justify">
                                                <small>{{ __('By clicking Continue, I confirm I have the agreement of the receiver of funds to provide their personal their information to Paysafe in order to verify their identity and process the payment.') }}</small>
                                            </div>
                                        </div>

                                        <div class="row m-0 justify-content-between mt-2">
                                            <div>
                                                <a href="{{url('remittance')}}" class="remittance-confirm-back-btn">
