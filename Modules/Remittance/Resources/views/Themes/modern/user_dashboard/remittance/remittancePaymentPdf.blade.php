        ...
        <table>
            <tr>
                <td>
                    <table>
                        <tr>
                            <td style="font-size:16px; color:#000000; line-height:25px; font-weight:bold;">{{ __('Remittance Pay with') }}</td>
                        </tr>
                        <tr>
                            <td style="font-size:15px; color:#4e5c6e; line-height:22px;">
                                @php
                                $paymentMethod = '';
                                if(isset($transactionDetails->payment_method->name)) {
                                $paymentMethod = ($transactionDetails->payment_method->name == "Mts") ? "Pay Money" : $transactionDetails->payment_method->name;
                                }
                        ...
                        <br><br>
                        <tr>
                            <td style="font-size:16px; color:#000000; line-height:25px; font-weight:bold;">{{ __('Remittance Pay Currency') }} </td>
                        </tr>
                        <tr>
            ...
            <tr>
                <td>
                    <table style="margin-top:20px; width:300px;">
                        <tr>
                            <td colspan="2" style="font-size:16px; color:#000000; font-weight:bold;">{{ __('Remittance Details') }}</td>
                        </tr>
                        <tr>
                            <td style="font-size:15px; color:#000000;">{{ __('Remittance Send Amount') }}</td>
