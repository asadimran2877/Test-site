    ...
    <section class="min-vh-100">
        <div class="my-30">
            <div class="container-fluid">
                <div><h3 class="page-title">{{ __('Wallets') }}</h3></div>
                <div class="row mt-4">
                    <div class="col-lg-4">
                        <div class="mt-5">
                            <h3 class="sub-title">{{ __('Wallet list') }}</h3>
                            <p class="text-gray-500 text-16 text-justify">{{ __('Here you will get all of your wallets including the default one') }}</p>
                        </div>
                    </div>
                    <div class="col-lg-8">
                        <div class="row">
                                            ...
                                            <div class="d-flex shadow bg-secondary p-5 justify-content-between">
                                                <div class="d-flex align-items-center ">
                                                    ...
                                                    <div class="pr-2">
                                                        ...
                                                        <p>
                                                            @if (isset($wallet->available_balance))
                                                                @if ($wallet->currency->type == 'fiat')
                                                                    <span class="text-success">{{ '+' . formatNumber($wallet->available_balance) }}</span>
                                                                @endif
                                                            @endif
                                                        </p>
                                                    </div>
