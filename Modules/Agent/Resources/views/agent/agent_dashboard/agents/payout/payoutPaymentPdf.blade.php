...
<head>
    <title>{{ __('Withdrawal | Print') }}</title>
    <meta charset="utf-8">
        ...
        <table>
            <tr>
                <td>
                    <table>
                        <tr>
                            <td class="agent-tbl-title">{{ __('Withdraw Via') }}</td>
                        </tr>
                        <tr>
                        ...
                        <br><br>
                        <tr>
                            <td class="agent-tbl-title">{{ __('Withdraw To') }}</td>
                        </tr>
                        <tr>
                            <td class="agent-tbl-val">
            ...
            <tr>
                <td>
                    <table class="agent-tbl-details">
                        ...
                        <tr>
                            <td class="agent-tbl-td-2">{{ __('Withdrawal Amount') }}</td>
                        ...
                        <tr>
                            ...
                            <td class="agent-tbl-td-3-bold">{{ moneyFormat($transactionDetails->currency->symbol,formatNumber($transactionDetails->total, $transactionDetails->currency_id)) }}</td>
                        </tr>
                    </table>
                </td>
            </tr>
