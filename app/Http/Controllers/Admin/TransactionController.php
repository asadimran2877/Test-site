        ...
        if (module('Remittance')) {
            ...
            if ($request->type == 'Remittance')
            {
                if ($request->status == 'Pending') //requested status
                {
                    ...
                    elseif ($t->status == 'Success') //current status
                    {
                        $remittances         = \Modules\Remittance\Entities\Remittance::find($request->transaction_reference_id);
                        ...
                        if (checkAppMailEnvironment()) {
                            $emailArr = (new \Modules\Remittance\Entities\Remittance)->remittanceStatusChangeMailToUser($remittances);
                ...
                elseif ($request->status == 'Success')
                {
                    ...
                    elseif ($t->status == 'Cancelled') //current status
                    {
                        $remittances         = \Modules\Remittance\Entities\Remittance::find($request->transaction_reference_id);
                        $remittances->status = $request->status;
                        $remittances->save();
                ...
                {
                    if ($t->status == 'Cancelled') //current status
                    {
                        $this->helper->one_time_message('success', 'Transaction is already Cancelled!');
                        return redirect(Config::get('adminPrefix').'/transactions');
                    }
