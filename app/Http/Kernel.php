...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'check-agent-active'                  => \Modules\Agent\Http\Middleware\CheckAgentActiveMiddleware::class,
        'check-agent-inactive'                => \Modules\Agent\Http\Middleware\CheckAgentInactiveMiddleware::class,
        'check-agent-suspended'               => \Modules\Agent\Http\Middleware\CheckAgentSuspendedMiddleware::class,
    ];
}
