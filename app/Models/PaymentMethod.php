...

{
    ...
    */
    ...
    public function cpm()
    {
        return $this->hasMany(CurrencyPaymentMethod::class, 'method_id');
    }

    public function fl()
    {
        return $this->hasMany(FeesLimit::class, 'payment_method_id');
    }
    public function remittance()
    {
        return $this->hasOne(\Modules\Remittance\Entities\Remittance::class);
    }
