...
if (!function_exists('getStatusInputLabel')) {
...

    {
        ...
        if (module('Remittance')) {
            $transactionTypes[Remittance] = ['user' => 'User', 'receiver' => 'Receiver'];
        }
...
if (! function_exists('getPaymoneySettings')) {
...

    {
        ...
        if (module('Agent')) {
            ...
            $array['payment_methods']['web']['all'][] = Cash;

            $array['payment_methods']['web']['deposit'][] = Cash;

            $array['payment_methods']['web']['withdrawal'][] = Cash;

            $array['payment_methods']['web']['fiat']['deposit'][] = Cash;

            $array['payment_methods']['web']['fiat']['withdrawal'][] = Cash;

        }


        if (module('Remittance')) {
            $array['transaction_types']['web']['sent'][] = Remittance;
        }
